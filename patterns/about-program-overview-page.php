<?php
/**
 * Title: About — full page (Program Overview)
...
<!-- wp:pattern {"slug":"ccg-wp-theme/about-services-stats"} /-->
<!-- wp:pattern {"slug":"ccg-wp-theme/about-security"} /-->
<!-- wp:pattern {"slug":"ccg-wp-theme/about-cta"} /-->
</div>
<!-- /wp:group -->
